<x-app-layout>
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Register a new laboratory test request for an existing patient.
                </p>
    ...
    <div class="min-h-screen bg-slate-900 py-8">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <form
                method="POST"
                action="{{ route('test-requests.store') }}"
                id="testRequestForm"
            >
                ...
                <tr class="test-row">
                        ...
                        >
                            ...
                            @foreach($testTypes as $testType)
                                ...
                                <option
                                    ...
                                    @selected(old('items.0.test_type_id') == $testType->id)
                                >
                    ...
                    <td class="px-6 py-4">
                        ...
                        <input
                            type="number"
                            name="items[0][price]"
                            class="test-price w-full rounded-lg border border-slate-600 bg-slate-900 text-right text-white focus:border-indigo-500 focus:ring-indigo-500"
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        <button
                            type="button"
                            class="remove-test-row rounded-lg bg-red-600 px-3 py-2 text-sm font-semibold text-white transition hover:bg-red-700"
                        >
                            Remove
                        </button>
